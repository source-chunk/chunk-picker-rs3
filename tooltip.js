const tooltipTexts = {
    ...
    'wieldCraftedItemsOverrideRuleTooltip': `A <i><b>partial product</b></i> is an item that is only ever used as a crafting component in the processing chain of one specific item or set of items (unfinished potions, unfired urns, components for masterwork equipment, etc.)`,
};
