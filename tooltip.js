const tooltipTexts = {
    ...
    'slayerLockingTooltip': `<i><b>What is Slayer Locking?</b></i> When receiving a slayer task from a slayer master, if you're unable to complete the task within your unlocked chunks, you are now Slayer Locked.<br /><br />This interface allows you to select if you have gotten Slayer Locked, and provide your currently reached Slayer level and what task you got locked by, so that the Chunk Picker can account for you being locked.<br /><br />Your Slayer Lock will be automatically removed once you unlock a way to complete your locked task, or can be manually unlocked at any time. <br /> <br />Your Slayer Lock will always be automatically removed if you have a primary Slayer training method that doesn't require a Slayer task, like completing Slayer contracts.`
};
