const tooltipTexts = {
    ...
    'diariesColorTooltip': `<div>Achievement sets in <span style="color:green">green</span> indicate an achievement set that you can complete within your chunks.</div><hr /><div>Achievement sets in <span style="color:yellow">yellow</span> indicate an achievement set that can be started, but not completed within your chunks.</div><hr /><div>Achievement sets in <span style="color:grey">grey</span> indicate an achievement set that cannot be started yet.</div>`,
    ...
    'slayerLockingTooltip': `<i><b>What is Slayer Locking?</b></i> When receiving a Slayer task from a Slayer master, or a Reaper assignment from Death, if you're unable to complete the task within your unlocked chunks, you are now Slayer Locked.<br /><br />This interface allows you to select if you have gotten Slayer Locked, and provide your currently reached Slayer level and what task you got locked by, so that the Chunk Picker can account for you being locked.<br /><br />Your Slayer Lock will be automatically removed once you unlock a way to complete <b>at least one</b> of your locked tasks, or can be manually unlocked at any time. <br /> <br />Your Slayer Lock will always be automatically removed if you have a primary Slayer training method that doesn't require a Slayer task, like completing Slayer contracts.`
};
